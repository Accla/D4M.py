...
@pytest.mark.parametrize("test_row,test_col,test_val,adj,aggregate,exp_row,exp_col,exp_val,exp_adj",
                         [('a,b,', 'A,B,', 1, None, None, np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(np.array([[1.0, 0], [0, 1.0]]))),
                          ('a,b,b,', 'A,B,A,', 1, None, None, np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(np.array([[1.0, 0], [1.0, 1.0]]))),
                          ('a,b,', 'A,B,', 'aA,bB,', None, None, np.array(['a', 'b']), np.array(['A', 'B']),
                           np.array(['aA', 'bB']), sp.coo_matrix(np.array([[1, 0], [0, 2]]))),
                          (['a', 'b'], 'A,B,', [1, 1], None, None, np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(np.array([[1.0, 0], [0, 1.0]]))),
                          ([1, 2], 'A,B,', [1, 1], None, None, np.array([1, 2]), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(np.array([[1.0, 0], [0, 1.0]]))),
                          ([], 'A,B,', 1, None, None, np.empty(0), np.empty(0), 1.0,
                           sp.coo_matrix(([], ([], [])), shape=(0, 0))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, D4M.util.add, np.array(['a', 'b']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[4.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, 'add', np.array(['a', 'b']), np.array(['A', 'B']),
                           1.0, sp.coo_matrix(np.array([[4.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, D4M.util.first, np.array(['a', 'b']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[1.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, 'first', np.array(['a', 'b']), np.array(['A', 'B']),
                           1.0, sp.coo_matrix(np.array([[1.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, D4M.util.last, np.array(['a', 'b']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[3.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, 'last', np.array(['a', 'b']), np.array(['A', 'B']),
                           1.0, sp.coo_matrix(np.array([[3.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, min, np.array(['a', 'b']), np.array(['A', 'B']),
                           1.0, sp.coo_matrix(np.array([[1.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [1, 2, 3], None, max, np.array(['a', 'b']), np.array(['A', 'B']),
                           1.0, sp.coo_matrix(np.array([[3.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,A,', [3, 2, 3], None, D4M.util.times, np.array(['a', 'b']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[9.0, 0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,B,', 1.0, sp.coo_matrix(np.array([[1.0, 3.0], [0, 2.0]])), None,
                           np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(np.array([[1.0, 3.0], [0, 2.0]]))),
                          ('a,b,a,', 'A,B,B,', ['aA', 'bA', 'aB'], sp.coo_matrix(np.array([[1, 3], [0, 2]])), None,
                           np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'aB', 'bA']),
                           sp.coo_matrix(np.array([[1, 3], [0, 2]]))),
                          ('a,b,', 'A,B,', ['aA', 'bA', 'aB'], sp.coo_matrix(np.array([[1, 3], [0, 2]])), None,
                           np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'aB', 'bA']),
                           sp.coo_matrix(np.array([[1, 3], [0, 2]]))),
                          ('a,b,', 'A,B,', 'aA,aB,bA,bB,', sp.coo_matrix(np.array([[1, 3], [4, 2]])), 'unique',
                           np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'aB', 'bA', 'bB']),
                           sp.coo_matrix(np.array([[1, 3], [4, 2]]))),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'aB', 'bA', 'bB']),
                           sp.coo_matrix(np.array([[1, 3], [4, 2]])), 'unique', np.array(['a', 'b']),
                           np.array(['A', 'B']), np.array(['aA', 'aB', 'bA', 'bB']),
                           sp.coo_matrix(np.array([[1, 3], [4, 2]]))),
                          (np.array(['a', 'b']), np.array(['B', 'A']), np.array(['aA', 'aB', 'bA', 'bB']),
                           sp.coo_matrix(np.array([[1, 3], [4, 2]])), 'unique', np.array(['a', 'b']),
                           np.array(['B', 'A']), np.array(['aA', 'aB', 'bA', 'bB']),
                           sp.coo_matrix(np.array([[1, 3], [4, 2]]))),
                          ('a,b,', 'B,A,', 'aA,aB,bA,bB,', sp.coo_matrix(np.array([[1, 3], [4, 2]])), 'unique',
                           np.array(['a', 'b']), np.array(['B', 'A']), np.array(['aA', 'aB', 'bA', 'bB']),
                           sp.coo_matrix(np.array([[1, 3], [4, 2]])))
                          ])
def test_assoc_constructor(test_row, test_col, test_val, adj, aggregate, exp_row, exp_col, exp_val, exp_adj):
...
@pytest.mark.parametrize("test_row,test_col,test_val,adj,aggregate,prevent_upcasting,convert,exp_row,exp_col,exp_val,"
                         + "exp_adj",
                         [('a,b,c,', 'A,A,B,', '1,2,3,', None, None, None, True, np.array(['a', 'b', 'c']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[1, 0], [2, 0], [0, 3]]),
                                                                    dtype=float)),
                          ('a,b,c,', 'A,A,B,', '1,2,3,', None, None, True, False, np.array(['a', 'b', 'c']),
                           np.array(['A', 'B']), np.array(['1', '2', '3']), sp.coo_matrix(np.array([[1, 0], [2, 0],
                                                                                                    [0, 3]]),
                                                                                          dtype=int)),
                          ('a,b,c,', 'A,A,B,', '1.0,2,3,', None, None, True, True, np.array(['a', 'b', 'c']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[1, 0], [2, 0], [0, 3]]),
                                                                    dtype=float)),
                          ('a,b,c,', 'A,A,B,', '1,2,3,', None, None, True, True, np.array(['a', 'b', 'c']),
                           np.array(['A', 'B']), 1.0, sp.coo_matrix(np.array([[1, 0], [2, 0], [0, 3]]),
                                                                    dtype=int))
                          ])
def test_assoc_constructor_convert_upcast(test_row, test_col, test_val, adj, aggregate, prevent_upcasting, convert,
                                          exp_row, exp_col, exp_val, exp_adj):
    adj, aggregate = replace_default_args(D4M.assoc.Assoc, adj=adj, aggregate=aggregate)
    assoc_ = D4M.assoc.Assoc(test_row, test_col, test_val, adj=adj, aggregate=aggregate,
                             prevent_upcasting=prevent_upcasting, convert_val=convert)
    assert np.array_equal(assoc_.row, exp_row)
    assert np.array_equal(assoc_.col, exp_col)
    assert np.array_equal(assoc_.val, exp_val) or (assoc_.val == 1.0 and exp_val == 1.0)
    assert D4M.assoc.sparse_equal(assoc_.adj, exp_adj)
...
@pytest.mark.parametrize("test_row,test_col,test_val,test_adj,canonical",
                         [(np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), True),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'bB']),
                           sp.coo_matrix(([1, 2, 1], ([0, 1, 1], [0, 0, 1])), dtype=int), True),
                          (['a', 'b'], np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), 2.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float).tocsr(), False),
                          (np.array(['a', 'b']), np.array(['B', 'A']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B', 'B']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 1, 1], [0, 0, 1])), dtype=float, shape=(3, 3)), False),
                          (np.array(['a', 'b', 'c']), np.array(['A', 'B', 'C']), 1.0,
                           sp.coo_matrix(([1, 1, 1], ([0, 2, 2], [0, 0, 2])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix(([1, 0, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['', 'aA', 'bB']),
                           sp.coo_matrix(([1, 2, 3], ([0, 1, 1], [0, 0, 1])), dtype=int), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['bB', 'aA']),
                           sp.coo_matrix(([1, 2, 1], ([0, 1, 1], [0, 0, 1])), dtype=int), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'aA', 'bB']),
                           sp.coo_matrix(([1, 2, 1], ([0, 1, 1], [0, 0, 1])), dtype=int), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'bB']),
                           sp.coo_matrix(([1, 2, 0], ([0, 1, 1], [0, 0, 1])), dtype=int), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'bB']),
                           sp.coo_matrix(([1, 2, 3], ([0, 1, 1], [0, 0, 1])), dtype=int), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'bB']),
                           sp.coo_matrix(([1, 2, 1], ([0, 1, 1], [0, 0, 1])), dtype=float), False),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'bA', 'bB']),
                           sp.coo_matrix(([1, 3, 1], ([0, 1, 1], [0, 0, 1])), dtype=int), False),
                          ])
def test_is_canonical(test_row, test_col, test_val, test_adj, canonical):
    test_assoc = D4M.assoc.Assoc([], [], [])  # Modify empty array to ensure no modification of arguments
...
def test_dropzeros(test_row, test_col, test_val, test_adj, exp_assoc):
    test_assoc = D4M.assoc.Assoc(test_row, test_col, test_val, test_adj, aggregate='unique')
...
@pytest.mark.parametrize("test_row,test_col,test_val,test_adj,exp_assoc",
                         [(np.array(['a', 'b', 'c']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix((np.array([1, 1]), (np.array([0, 1]), np.array([0, 1])))),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 1)),
                          (np.array(['a', 'b']), np.array(['A', 'B', 'C']), 1.0,
                           sp.coo_matrix((np.array([1, 1]), (np.array([0, 1]), np.array([0, 1])))),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 1)),
                          (np.array(['a', 'b', 'c']), np.array(['A', 'B', 'C']), np.array(['aA', 'bB']),
                           sp.coo_matrix((np.array([1, 2], dtype=int), (np.array([0, 1]), np.array([0, 1])))),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 'aA,bB,')),
                          (np.array(['a']), np.array(['A']), np.array([]),
...
@pytest.mark.parametrize("test_row,test_col,test_val,test_adj,exp_assoc",
                         [(np.array(['a', 'b']), np.array(['A', 'B']), 1.0,
                           sp.coo_matrix((np.array([1, 1, 1]), (np.array([0, 0, 1]), np.array([0, 1, 1])))),
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1)),
                          (np.array(['a', 'b']), np.array(['A', 'B']), np.array(['aA', 'aB', 'bB']),
                           sp.coo_matrix((np.array([1, 3]), (np.array([0, 1]), np.array([0, 1]))), dtype=int),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 'aA,bB,')),
                          (np.array([]), np.array([]), np.array(['aA']),
                           sp.coo_matrix((np.array([]), (np.array([]), np.array([]))), shape=(0, 0)),
                           D4M.assoc.Assoc([], [], []))
                          ])
...
@pytest.mark.parametrize("test_assoc,new_row,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), '1,2,', D4M.assoc.Assoc('1,1,2,', 'A,B,B,', 1)),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), '1,2,3,', D4M.assoc.Assoc('1,1,2,', 'A,B,B,', 1)),
                          ])
def test_set_row(test_assoc, new_row, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc.set_row(new_row), exp_assoc)


@pytest.mark.parametrize("test_assoc,new_col,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), '1,2,', D4M.assoc.Assoc('a,a,b,', '1,2,2,', 1))
                          ])
def test_set_col(test_assoc, new_col, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc.set_col(new_col), exp_assoc)


@pytest.mark.parametrize("test_assoc,new_val,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), '1,2,', D4M.assoc.Assoc('a,a,b,', 'A,B,B,', '1,')),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), '2,', D4M.assoc.Assoc('a,a,b,', 'A,B,B,', '2,')),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), 2, D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 2)),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'), 'Aa,Ba,Bb,',
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'Aa,Ba,Bb,')),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'), 0, D4M.assoc.Assoc([], [], []))
                          ])
def test_set_val(test_assoc, new_val, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc.set_val(new_val), exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc,new_adj,numerical,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), sp.coo_matrix(([1, 2, 3], ([0, 0, 1], [0, 1, 1]))),
                           None, D4M.assoc.Assoc('a,a,b,', 'A,B,B,', [1, 2, 3])),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), sp.coo_matrix(([1], ([0], [0]))),
                           None, D4M.assoc.Assoc('a,', 'A,', 1)),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'), sp.coo_matrix(([1, 2, 3], ([0, 0, 1],
                                                                                                        [0, 1, 1]))),
                           None, D4M.assoc.Assoc('a,a,b,', 'A,B,B,', [1, 2, 3])),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'), sp.coo_matrix(([1, 2, 3], ([0, 0, 1],
                                                                                                        [0, 1, 1]))),
                           False, D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,')),
                          ])
def test_set_adj(test_assoc, new_adj, numerical, exp_assoc):
    ...
    assert D4M.assoc.assoc_equal(test_assoc.set_adj(new_adj, numerical=numerical), exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc,row_key,col_key,value,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), 'c', 'C', 1.5,
...
@pytest.mark.parametrize("test_assoc,exp_dict",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', [2, 3]), {'a': {'A': 2}, 'b': {'B': 3}}),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 'aA,bB,'), {'a': {'A': 'aA'}, 'b': {'B': 'bB'}}),
...
@pytest.mark.parametrize("test_assoc",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', 1)),
                          ...
                          (D4M.assoc.Assoc('a,b,a,', 'A,B,B,', 1.0, sp.coo_matrix(np.array([[1.0, 3.0], [0, 2.0]])))),
                          (D4M.assoc.Assoc('a,b,a,', 'A,B,B,', ['aA', 'bA', 'aB'],
                                           sp.coo_matrix(np.array([[1, 3], [0, 2]])))),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', ['aA', 'bA', 'aB'],
                                           sp.coo_matrix(np.array([[1, 3], [0, 2]])))),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 'aA,aB,bA,bB,', sp.coo_matrix(np.array([[1, 3], [4, 2]])),
                                           'unique')),
                          (D4M.assoc.Assoc(np.array(['a', 'b']), np.array(['A', 'B']),
                                           np.array(['aA', 'aB', 'bA', 'bB']),
                                           sp.coo_matrix(np.array([[1, 3], [4, 2]])), 'unique')),
                          (D4M.assoc.Assoc(np.array(['a', 'b']), np.array(['B', 'A']),
                                           np.array(['aA', 'aB', 'bA', 'bB']),
                                           sp.coo_matrix(np.array([[1, 3], [4, 2]])), 'unique')),
                          (D4M.assoc.Assoc('a,b,', 'B,A,', 'aA,aB,bA,bB,', sp.coo_matrix(np.array([[1, 3], [4, 2]])),
                                           'unique'))
                          ])
...
@pytest.mark.parametrize("test_row,test_col,test_val,adj,aggregate,val",
...
@pytest.mark.parametrize("test_assoc,row_key,col_key,value",
...
@pytest.mark.parametrize("test_assoc,subrow,subcol,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', [2, 3]), 'a,', 'A,B,', D4M.assoc.Assoc('a,', 'A,', [2])),
                          ...
                          (D4M.assoc.Assoc('amber,ash,birch,', 'color,color,color,', 'amber,auburn,white,'),
                           np.array([0, 1]), ":", D4M.assoc.Assoc('amber,ash,', 'color,color,', 'amber,auburn,')),
                          (D4M.assoc.Assoc('amber,ash,birch,', 'color,size,beauty,', 'amber,big,ugly,'),
                           ':', np.array([0, 2]), D4M.assoc.Assoc('ash,birch,', 'size,beauty,', 'big,ugly,')),
                          (D4M.assoc.Assoc('amber,ash,birch,', 'color,color,color,', 'amber,auburn,white,'),
                           slice(0, 2, 1), slice(None, None, None),
                           D4M.assoc.Assoc('amber,ash,', 'color,color,', 'amber,auburn,'))
                          ])
...
@pytest.mark.parametrize("test_assoc,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1)),
                          (D4M.assoc.Assoc('a,b,b,', 'a,a,b,', 2), D4M.assoc.Assoc('a,b,b,', 'a,a,b,', 1)),
                          (D4M.assoc.Assoc([1, 2, 2, 5], [1, 3, 2, 5], [2.4, 1, 9.7, -1]),
...
@pytest.mark.parametrize("test_assoc,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), D4M.assoc.Assoc('A,A,B,', 'a,b,b,', 1)),
                          (D4M.assoc.Assoc('a,b,b,', 'a,a,b,', 2), D4M.assoc.Assoc('a,a,b,', 'a,b,b,', 2)),
                          (D4M.assoc.Assoc([1, 2, 2, 5], [1, 3, 2, 5], [2.4, 1, 9.7, -1]),
...
@pytest.mark.parametrize("test_assoc,axis,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), None, 3),
                          ...
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA,bA,bB,'), 1, D4M.assoc.Assoc('a,b,', 0, [1, 2])),
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA,bA,bB,'), 0, D4M.assoc.Assoc(0, 'A,B,', [2, 1])),
                          (D4M.assoc.Assoc('a,b,b,c,c,', 'A,A,B,A,B,', [7, -1, 4.5, 3, -3]), None, 10.5),
                          (D4M.assoc.Assoc('a,b,b,c,c,', 'A,A,B,A,B,', [7, -1, 4.5, 3, -3]), 1,
                           D4M.assoc.Assoc('a,b,', 0, [7, 3.5])),
                          (D4M.assoc.Assoc('a,b,b,c,c,', 'A,A,B,A,B,', [7, -1, 4.5, 3, -3]), 0,
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,binary_op,right_zero,left_zero,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,b,', 'A,B,', 1),
                           D4M.util.add, None, None, D4M.assoc.Assoc('a,b,', 'A,B,', 2)),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,b,', 'A,C,', 1),
                           D4M.util.add, None, None, D4M.assoc.Assoc('a,b,b,', 'A,B,C,', [2, 1, 1])),
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA,bA,bB,'),
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'),
                           D4M.util.add, None, None, D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', 'aAaA,aB,bA,bBbB,')),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 2), D4M.assoc.Assoc('a,b,', 'A,B,', 3),
                           D4M.util.times, None, None, D4M.assoc.Assoc('a,b,', 'A,B,', 6)),
                          (D4M.assoc.Assoc('a,b,c,', 'A,B,C,', 2), D4M.assoc.Assoc('a,b,d,', 'A,B,D,', 3),
                           D4M.util.times, True, True, D4M.assoc.Assoc('a,b,', 'A,B,', 6))
                          ])
def test_combine(test_assoc_1, test_assoc_2, binary_op, right_zero, left_zero, exp_assoc):
    combined_assoc = test_assoc_1.combine(test_assoc_2, binary_op, right_zero=right_zero, left_zero=left_zero)
    assert D4M.assoc.assoc_equal(combined_assoc, exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc_1,test_assoc_2,semi_add,semi_mult,exp_assoc",
                         [(D4M.assoc.Assoc([1, 1, 3], [2, 4, 6], [2, 4, 18]),
                           D4M.assoc.Assoc([2, 3, 4, 4], ['a', 'a', 'b', 'c'], 1),
                           D4M.util.add, D4M.util.times,
                          ...
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc([], [], []),
                           D4M.util.add, D4M.util.times,
                           D4M.assoc.Assoc([], [], [])),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,b,', 'A,B,', 1),
                           D4M.util.add, D4M.util.times,
...
def test_add(test_assoc_1, test_assoc_2, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1 + test_assoc_2, exp_assoc, return_info=True)
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,b,', 'A,B,', 1),
                          ...
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('A,B,', 'a,b,', 1),
                           D4M.assoc.Assoc('a,b,', 'a,b,', 1)),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1), D4M.assoc.Assoc('A,A,B,', 'a,b,b,', 1),
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1),
                          ...
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), D4M.assoc.Assoc([], [], []),
                           D4M.assoc.Assoc([], [], [])),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('b,a,', 'A,B,', 1),
                           D4M.assoc.Assoc([], [], [])),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,', 'A,', 'aA,'),
                           D4M.assoc.Assoc('a,', 'A,', 1)),
                          (D4M.assoc.Assoc('a,b,', 'A,B,', 'aA,bB,'), D4M.assoc.Assoc('a,', 'A,', 1),
                           D4M.assoc.Assoc('a,', 'A,', 'aA,')),
                          (D4M.assoc.Assoc('1,2,2,', '0,0,1,', [2, 3, 4]),
                           D4M.assoc.Assoc('1,1,2,', '0,1,1,', [2, 3, 4]),
                           D4M.assoc.Assoc('1,2,', '0,1,', [4, 16])),
                          (D4M.assoc.Assoc('a,b,c,', 'A,B,C,', 1), D4M.assoc.Assoc('a,b,d,', 'A,B,D,', 1),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 1)),
                          (D4M.assoc.Assoc('a,b,c,', 'A,B,C,', 2), D4M.assoc.Assoc('a,c,', 'A,C,', 'aA,cC,'),
                           D4M.assoc.Assoc('a,c,', 'A,C,', 2)),
                          (D4M.assoc.Assoc('a,b,c,', 'A,B,C,', 'Aa,Bb,Cc,'), D4M.assoc.Assoc('a,c,', 'A,C,', 'aA,cC,'),
                           D4M.assoc.Assoc('a,c,', 'A,C,', 'Aa,Cc,')),
                          (D4M.assoc.Assoc('a,b,c,', 'A,B,C,', 'Aa,Bb,Cc,'), D4M.assoc.Assoc('a,c,', 'A,C,', 2),
                           D4M.assoc.Assoc('a,c,', 'A,C,', 'Aa,Cc,'))
                          ])
def test_elementwise_multiply(test_assoc_1, test_assoc_2, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1.multiply(test_assoc_2), exp_assoc, return_info=True)
...
def test_elementwise_divide(test_assoc_1, test_assoc_2, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1.divide(test_assoc_2), exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc,scalar,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', [1, 2, 3]), 3,
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', [3, 6, 9])),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'), 3,
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 3)),
                          (D4M.assoc.Assoc([], [], []), 3, D4M.assoc.Assoc([], [], [])),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,B,', [1, 2, 3]), 0, D4M.assoc.Assoc([], [], []))
                          ])
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,sort_key,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,b,', 'A,B,', 2), None,
                           D4M.assoc.Assoc('a,b,', 'A,B,', 1)),
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', [-1, 1, 2]), D4M.assoc.Assoc([], [], []), None,
                           D4M.assoc.Assoc('a,', 'A,', [-1])),
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA1,bA1,bB2,'),
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA2,aB2,bB1,'), None,
                           D4M.assoc.Assoc('a,b,', 'A,B,', 'aA1,bB1,')),
                          (D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', 'aA1,,bA1,bB2,'),
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', 'aA2,aB2,,bB1,'), str.__lt__,
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', 'aA1,,,bB1,')),
                          (D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', [10, 0, 2, -2]),
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', [2, -1, 0, -1]), num_lex_sort,
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', [10, -1, 0, -1])),
                          (D4M.assoc.Assoc('a,b,b,c,d,', 'A,A,B,C,D,', 'aAA,bAA,bZ,cC,,'),
                           D4M.assoc.Assoc('a,b,b,c,d,', 'A,A,B,C,D,', 'aZ,bZ,bBB,,dD,'), shortlex_sort,
                           D4M.assoc.Assoc('a,b,b,c,d,', 'A,A,B,C,D,', 'aZ,bZ,bZ,,,'))
                          ])
def test_min(test_assoc_1, test_assoc_2, sort_key, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1.min(test_assoc_2, sort_key=sort_key), exp_assoc, return_info=True)
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,sort_key,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,', 'A,B,', 1), D4M.assoc.Assoc('a,b,', 'A,B,', 2), None,
                          ...
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA1,bA1,bB2,'),
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA2,aB2,bB1,'), str.__lt__,
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', 'aA2,aB2,bA1,bB2,')),
                          (D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', [10, 0, 2, -2]),
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', [2, -1, 0, -1]), num_lex_sort,
...
def test_max(test_assoc_1, test_assoc_2, sort_key, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1.max(test_assoc_2, sort_key=sort_key), exp_assoc, return_info=True)
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1),
                          ...
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA,bA,bB,'),
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 1)),
                          (D4M.assoc.Assoc('a,', 'A,', 1), D4M.assoc.Assoc('b,', 'B,', 1), D4M.assoc.Assoc([], [], []))
                          ])
...
@pytest.mark.parametrize("test_assoc_1,test_assoc_2,exp_assoc",
                         [(D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 1), D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1),
                          ...
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', 'aA,bA,bB,'),
                           D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 'aA,aB,bB,'),
                           D4M.assoc.Assoc('a,a,b,b,', 'A,B,A,B,', 1)),
                          (D4M.assoc.Assoc('a,', 'A,', 1), D4M.assoc.Assoc('b,', 'B,', 1),
                           D4M.assoc.Assoc('a,b,', 'A,B,', 1))
                          ])
...
@pytest.mark.parametrize("test_assoc,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,B,', 1),
                          ...
                          (D4M.assoc.Assoc('a,b,b,', 'A,A,B,', [2, 3, 1]),
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,', [4, 6, 6, 10])),
                          (D4M.assoc.Assoc([2, 2, 4, 6], [1, 3, 3, 1], 1),
                           D4M.assoc.Assoc([2, 2, 2, 4, 4, 6, 6], [2, 4, 6, 2, 4, 2, 6], [2, 1, 1, 1, 1, 1, 1]))
                          ])
def test_sqout(test_assoc, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc.sqout(), exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc_1,test_assoc_2,delimiter,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,A,', 1), D4M.assoc.Assoc('A,A,B,', 'a,b,b,', 1), None,
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,', 'A;,A;B;,A;,A;,')),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,A,', 'aA,aB,bA,'), D4M.assoc.Assoc('A,A,B,', 'a,b,b,', 2),
                           None, D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,', 'A;,A;B;,A;,A;,')),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,A,', 1), D4M.assoc.Assoc('A,A,B,', 'a,b,b,', 1), '|',
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,', 'A|,A|B|,A|,A|,')),
                          (D4M.assoc.Assoc('a,a,b,c,', 'A,B,A,C,', 1), D4M.assoc.Assoc('A,A,B,D,', 'a,b,b,d,', 1), '+',
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,', 'A+,A+B+,A+,A+,')),
                          (D4M.assoc.Assoc([1, 1, 3, 3], [2, 4, 2, 10], [1, 1, 2, 1]),
                           D4M.assoc.Assoc([2, 2, 4, 10, 10], [1, 3, 1, 1, 3], [-10, 2, 10, 10, 1]), None,
...
def test_catkeymul(test_assoc_1, test_assoc_2, delimiter, exp_assoc):
    ...
    assert D4M.assoc.assoc_equal(test_assoc_1.catkeymul(test_assoc_2, delimiter=delimiter), exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc_1,test_assoc_2,pair_delimiter,delimiter,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,', 'A,B,A,', [1, 2, 3]),
                           D4M.assoc.Assoc('A,A,B,', 'a,b,b,', [3, 2, 1]), None, None,
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,', ['1,3,;', '1,2,;2,1,;', '3,3,;', '3,2,;'])),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,A,', 'aA,aB,bA,'),
                           D4M.assoc.Assoc('A,A,B,', 'a,b,b,', [3, 2, 1]),
                           None, None, D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,',
                                                       ['aA,3,;', 'aA,2,;aB,1,;', 'bA,3,;', 'bA,2,;'])),
                          (D4M.assoc.Assoc('a,a,b,', 'A,B,A,', 'aA,aB,bA,'),
                           D4M.assoc.Assoc('A,A,B,', 'a,b,b,', 'Aa,Ab,Bb,'), '|', None,
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,',
                          ...
                          (D4M.assoc.Assoc('a,a,b,c,', 'A,B,A,C,', 'aA,aB,bA,cC,'),
                           ...
                           D4M.assoc.Assoc('a,a,b,b,', 'a,b,a,b,',
                                           ['aA*Aa*+', 'aA*Ab*+aB*Bb*+', 'bA*Aa*+', 'bA*Ab*+'])),
                          (D4M.assoc.Assoc([1, 1, 3, 3], [2, 4, 2, 10], [1, 1, 2, 1]),
                           D4M.assoc.Assoc([2, 2, 4, 10, 10], [1, 3, 1, 1, 3], [-10.5, 2, 10, 10, 1]), None, '&',
                           D4M.assoc.Assoc([1, 1, 3, 3], [1, 3, 1, 3],
                                           ['1,-10.5,&1,10,&', '1,2,&', '2,-10.5,&1,10,&', '2,2,&1,1,&']))
                          ])
def test_catvalmul(test_assoc_1, test_assoc_2, pair_delimiter, delimiter, exp_assoc):
    pair_delimiter, delimiter = replace_default_args(D4M.assoc.Assoc.catvalmul, pair_delimiter=pair_delimiter,
                                                     delimiter=delimiter)
    assert D4M.assoc.assoc_equal(test_assoc_1.catvalmul(test_assoc_2, pair_delimiter=pair_delimiter,
                                                        delimiter=delimiter), exp_assoc, return_info=True)


@pytest.mark.parametrize("test_assoc_1,test_assoc_2,sort_key,exp_assoc",
                         [(D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [10, 0, 2, -1, 1]),
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [2, -1, 0, -2, 1]), num_lex_sort,
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [1, 0, 0, 1, 0])),
                          (D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [2, -1, 0, -2, 1]),
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [10, 0, 2, -1, 1]), num_lex_sort,
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [0, 1, 1, 0, 0])),
                          (D4M.assoc.Assoc('a,b,b,c,d,e,', 'A,A,B,C,D,E,', 'aAA,bAA,bZ,cC,,eE,'),
                           D4M.assoc.Assoc('a,b,b,c,d,e,', 'A,A,B,C,D,E,', 'aZ,bZ,bBB,,dD,eE,'), shortlex_sort,
                           D4M.assoc.Assoc('a,b,b,c,d,e,', 'A,A,B,C,D,E,', [0, 0, 1, 0, 1, 0])),
                          (D4M.assoc.Assoc('a,b,b,c,d,e,', 'A,A,B,C,D,E,', 'aZ,bZ,bBB,,dD,eE,'),
                           D4M.assoc.Assoc('a,b,b,c,d,e,', 'A,A,B,C,D,E,', 'aAA,bAA,bZ,cC,,eE,'), shortlex_sort,
                           D4M.assoc.Assoc('a,b,b,c,d,e,', 'A,A,B,C,D,E,', [1, 1, 0, 1, 0, 0]))
                          ])
def test_compare(test_assoc_1, test_assoc_2, sort_key, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1.compare(test_assoc_2, sort_key), exp_assoc)
...
def test_compare_inverse(test_assoc_1, test_assoc_2, sort_key, exp_assoc):
    assert D4M.assoc.assoc_equal(test_assoc_1.compare(test_assoc_2, sort_key, inverse=True), exp_assoc)


@pytest.mark.parametrize("test_assoc_1,test_assoc_2,sort_key,exp_assoc_1,exp_assoc_2",
                         [(D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [10, 0, 2, -1, 1]),
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [2, -1, 0, -2, 1]), num_lex_sort,
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [1, 0, 0, 1, 0]),
                           D4M.assoc.Assoc('a,a,b,b,c,', 'A,B,A,B,C,', [0, 1, 1, 0, 0])),
...
def test_compare_include_inverse(test_assoc_1, test_assoc_2, sort_key, exp_assoc_1, exp_assoc_2):
    compared, inv_compared = test_assoc_1.compare(test_assoc_2, sort_key, include_inverse=True)
...
@pytest.mark.parametrize("row,col,val,split_separator,int_aware,exp",
                         [('a,b,a,', 'A,B,B,', '1,2,3,', None, None, D4M.assoc.Assoc('a,b,a,', 'A|1,B|2,B|3,', 1)),
                          ('a,b,a,', 'A,B,B,', '1,2,3,', None, True, D4M.assoc.Assoc('a,b,a,', 'A|1,B|2,B|3,', 1)),
                          ('a,b,a,', 'A,B,B,', '1,2,3,', None, False, D4M.assoc.Assoc('a,b,a,', 'A|1,B|2,B|3,', 1)),
                          ('a,b,a,', 'A,B,B,', 'aA,bB,aB,', None, None,
                           D4M.assoc.Assoc('a,b,a,', 'A|aA,B|bB,B|aB,', 1)),
                          ('a,b,a,', 'A,B,B,', [1, 2, 3], ':', None, D4M.assoc.Assoc('a,b,a,', 'A:1,B:2,B:3,', 1)),
                          ('a,b,a,', 'A,B,B,', [1, 2, 3], ':', True, D4M.assoc.Assoc('a,b,a,', 'A:1,B:2,B:3,', 1)),
                          ('a,b,a,', 'A,B,B,', [1, 2, 3], ':', False,
                           D4M.assoc.Assoc('a,b,a,', 'A:1.0,B:2.0,B:3.0,', 1)),
                          ('a,b,a,', 'A,B,B,', '1,2,3,', '/', None, D4M.assoc.Assoc('a,b,a,', 'A/1,B/2,B/3,', 1))
                          ])
def test_val2col(row, col, val, split_separator, int_aware, exp):
    split_separator, int_aware = replace_default_args(D4M.util.catstr, separator=split_separator, int_aware=int_aware)
    assoc_ = D4M.assoc.Assoc(row, col, val)
    assert D4M.assoc.assoc_equal(D4M.assoc.val2col(assoc_, separator=split_separator, int_aware=int_aware), exp)


@pytest.mark.parametrize("A,separator,convert,row,col,val",
                         [(D4M.assoc.Assoc('a,b,a,', 'A|1,B|2,B|3,', 1), None, None, 'a,b,a,', 'A,B,B,', [1, 2, 3]),
                          (D4M.assoc.Assoc('a,b,a,', 'A|1,B|2,B|3,', 1), None, False, 'a,b,a,', 'A,B,B,',
                           ['1', '2', '3']),
                          (D4M.assoc.Assoc('a,b,a,', 'A|aA,B|bB,B|aB,', 1), None, None, 'a,b,a,', 'A,B,B,',
                           'aA,bB,aB,'),
                          (D4M.assoc.Assoc('a,b,a,', 'A:1,B:2,B:3,', 1), ':', None, 'a,b,a,', 'A,B,B,', [1, 2, 3]),
                          (D4M.assoc.Assoc('a,b,a,', 'A:1,B:2,B:3,', 1), ':', False, 'a,b,a,', 'A,B,B,',
                           ['1', '2', '3']),
                          (D4M.assoc.Assoc([], [], []), None, None, [], [], [])
                          ])
def test_col_to_type(A, separator, convert, row, col, val):
    separator, convert = replace_default_args(D4M.assoc.col_to_type, separator=separator, convert=convert)
    B = D4M.assoc.Assoc(row, col, val)
    assert D4M.assoc.assoc_equal(D4M.assoc.col_to_type(A, separator=separator, convert=convert), B,
                                 return_info=True)
